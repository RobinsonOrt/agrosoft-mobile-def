...
export const Cart = ({name, description, id, children}) => {
    return (
        <View style={[tw`h-210px mx-5 mb-5 rounded-xl mt-2`, styles.safeArea]}>
            ...
            <Text style={[tw`text-center mb-3 pr-2`, styles.description]}>{id}</Text>
            <View style={tw`flex-row justify-center w-full`}>{children}</View>
            </View>
        </View>
    )
