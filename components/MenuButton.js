  ...
  return (
    <TouchableOpacity
      ...
      style={
        isOpen
          ? [
              tw`bg-gray-300 flex-row mx-5 px-2 content-between items-center h-30px mb-5 rounded-md rounded-b-none border-b-2 border-white`,
              styles.colorButton,
            ]
          : [
              tw`bg-white-100 flex-row mx-5  px-2 content-between items-center h-30px mb-5 rounded-md`,
              styles.colorButton,
            ]
      }
    >
