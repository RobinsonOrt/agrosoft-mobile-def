...
export const MenuDropDownItems = ({
  ...
  statusAdmin,
  statusEmployee,
  statusRequestsMyFarms,
  statusRequestsOtherFarms,
}) => {
  ...
  const [isOpenRequests, setIsOpenRequests] = useState(
    statusRequestsMyFarms || statusRequestsOtherFarms
  );
  ...
  return (
    <>
      <View style={tw`mb-10`}>
        <MenuButtonDropDown
          title={"Usuario"}
          onPress={toggleOpenUser}
          isOpen={isOpenUser}
          status={statusUser}
          image={Profile}
          styleImage={tw`h-14px w-13px`}
          activeOpacity={0.6}
        />
        <View
          style={[
            ...
            styleView,
            styles.container,
            !statusUser && !isOpenUser ? styles.hidden : undefined,
          ]}
        >
          <MenuButtonItem
            status={statusUser}
            text="Perfil"
            onPress={() => {
              navigation.navigate("Administrar perfil");
              resetAccountStack();
            }}
          />
        </View>
        ...
        <MenuButtonDropDown
          title={"Administrador"}
          onPress={toggleOpenAdmin}
          isOpen={isOpenAdmin}
          status={statusAdmin}
          image={Admin}
          styleImage={tw`h-14px w-18px`}
          activeOpacity={0.6}
        />
        <View
          style={[
            ...
            styleView,
            styles.container,
            !statusAdmin && !isOpenAdmin ? styles.hidden : undefined,
          ]}
        >
          <MenuButtonItem
            status={statusAdmin}
        ...
        <MenuButtonDropDown
          title={"Empleado"}
          onPress={toggleOpenEmployee}
          isOpen={isOpenEmployee}
          status={statusEmployee}
          image={Employee}
          styleImage={tw`h-15px w-14px`}
          activeOpacity={0.6}
        />
        <View
          style={[
            ...
            styleView,
            styles.container,
            !statusEmployee && !isOpenEmployee ? styles.hidden : undefined,
          ]}
        >
          <MenuButtonItem
            status={statusEmployee}
        ...
        <MenuButtonDropDown
          title={"Solicitudes"}
          onPress={toggleOpenRequests}
          isOpen={isOpenRequests}
          status={statusRequestsMyFarms || statusRequestsOtherFarms}
          image={Requests}
          styleImage={tw`h-16px w-23px`}
          activeOpacity={0.6}
        />
        <View
          style={[
        ...
        >
          <MenuButtonItem
            status={statusRequestsMyFarms}
            text="Mis fincas"
            onPress={() => {
              navigation.navigate("Solicitudes mis fincas");
              resetRequestsMyFarmsStack();
            }}
          />
          <MenuButtonItem
            status={statusRequestsOtherFarms}
            text="Otras fincas"
            onPress={() => {
              navigation.navigate("Solicitudes otras fincas");
              resetRequestsOtherFarmStack();
            }}
          />
        </View>
      </View>
